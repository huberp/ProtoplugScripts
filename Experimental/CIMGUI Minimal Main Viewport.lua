--local protoplug_dir="C:\\Program Files\\Common Files\\VST3\\ProtoplugFiles"
...
print("\nPATH:  "..package.path)
package.cpath = protoplug_dir.."\\lib\\?.dll"..";"..package.cpath 
print("\nCPATH: "..package.cpath)

local ffi = require "ffi"
glfw3 = ffi.load(protoplug_dir.."\\lib\\glfw3.dll")
